...
public class BuildJsonForYapi {
     ...
     * @date: 2019/2/19
     */
    public static String getResponse(Project project, PsiType psiType, String returnClass) {
            ...
            if (Objects.nonNull(psiClass)) {
                ...
                for (PsiField field : psiClass.getAllFields()) {
                    if (NormalTypes.genericList.contains(field.getType().getPresentableText())) {
                        ...
                        kvObject.set(CaseFormatUtil.format(field.getName()), child);
                    }
                }
    ...
    public static KV getPojoJson(Project project, PsiType psiType) {
    ...
    public static void getField(PsiField field, Project project, KV kv, String[] childType, Integer index, Set<String> pNames) {
        ...
        String name = CaseFormatUtil.format(field.getName());
        String remark = "";
        //swagger支持
